...
export const workTimelineData: TimelineEntry[] = [
  {
    ...
    date: "2023",
    content: `
		In 2023 I transitioned into a Web Development role at Megasets and took over responsibility of the customer platform
		that empowered users to customize their unique configurations for data set generation.
		This included working with technologies such as React, Gatsby and Chakra UI, and implementing a wide range of features; 
		page routing, complex data manipulation, front-end to back-end interoperability and much more.
		...
		Further achievements including building a custom sensor editor with Three.js and a custom map view with Leaflet.js.`,
    badges: [
  ...
  },
  {
    ...
    content: `
		...
		Furthermore, I helped develop the simulation runner which could produce frame data from a varied range of virtual sensors.
		This invloved harnessing Unity's scriptable render pipelines to generate visual data,
		utilizing Unity animation tools to create realistic agent behaviour,
		and ensuring a seamless user experience within our tools.`,
    badges: [
  ...
  },
  {
    ...
    date: "2021",
    content: `
		As an admin and marketing assistant at Robson Analytics, 
		I was responsible for managing the company's social media presence,
		creating engaging content, and developing marketing strategies to increase brand awareness.
